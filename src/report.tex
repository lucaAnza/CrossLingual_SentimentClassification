...
\todo{Add a table with epochs , batch size , learning rate , ecc}
...
Talk about the first experiment was to understand which kind of training we want to do for the following question
\todo{TODO : LUCA}
